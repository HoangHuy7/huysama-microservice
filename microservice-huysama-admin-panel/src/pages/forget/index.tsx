...
function Forget() {
  ...
  // Đổi tiêu đề khi chuyển đổi ngôn ngữ
  useEffect(() => {
  ...
  /**
   * Đổi mật khẩu
   * @param values - Dữ liệu biểu mẫu
   */
  const handleFinish: FormProps['onFinish'] = async (values: ForgetData) => {
    // Nếu mật khẩu và xác nhận mật khẩu không giống nhau thì báo lỗi
